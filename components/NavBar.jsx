...
const Navbar = () => {
  const { isCmdPalette, setIsCmdPalette, handleOpenTask } = useContext(TaskContext);
  return (
    <div className="bg-skin-fill border border-l-2  w-[330px] h-screen flex flex-col justify-between	">
      <div className="flex flex-col gap-4 pt-6 items-center">
        ...
        <button onClick={handleOpenTask} className="pr-36 pl-2 border shadow-lg rounded-md focus:outline-none">
          <span>New Task</span>
        </button>
